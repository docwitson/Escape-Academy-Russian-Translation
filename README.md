...
Версия `0.1.0` — первый тестовый выпуск. Основной текст был переведён локальной
языковой моделью Qwen3.8-57K, затем прошёл автоматические проверки и игровое
...
Русификатор использует внутренний испанский языковой слот, добавляет кириллицу в
